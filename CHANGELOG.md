...
- Persistence: Prisma 7 + SQLite via the better-sqlite3 driver adapter. Immutable ledger
  schema (`Instrument` + `LedgerEntry`) with a unique constraint for idempotent ingestion.
